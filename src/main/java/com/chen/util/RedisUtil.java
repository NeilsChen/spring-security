...
public final class RedisUtil {
	...
	public static void del(String... key) {
		...
		if (key != null && key.length > 0) {
			...
			if (key.length == 1) {
				...
				staticRedisTemplate.delete(CollectionUtils.arrayToList(key));
	...
	/**
	 * 根据key关键字匹配所有key值
	 * @param keyPattern   token:*
	 * @return Set < String> key集合
	 */
	public static Set<String> allKeys(String keyPattern) {
		return staticRedisTemplate.keys(keyPattern);
